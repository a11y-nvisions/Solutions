...
class CustomSelect extends HTMLElement{
            ...
            if( val < opt.length){
                for(var i=0; i<opt.length; i++){
                    if(val===i){
                        ...
                        this.foundOptions=Array.prototype.slice.call(opt,val,opt.length);
    ...
    connectedCallback(root = this){
        ...
        function NavigateByCharactorKeys(list){
            ...
            const method = root.isExpanded ? root.setOptionExploreFocus : root.setSelect;
